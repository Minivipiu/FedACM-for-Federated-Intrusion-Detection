"""Data pipeline, backbone, local objective and evaluation for Edge-IIoTset.
...
def load_and_preprocess_dataset(
    ...
    """Load EdgeIIoT arrays and create a reusable global train/test split."""
    ...
    print(
        f"[Data] EdgeIIoT loaded: samples={len(y)}, "
