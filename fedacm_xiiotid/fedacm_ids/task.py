"""Data pipeline, backbone, local objective and evaluation for X-IIoTID.
...
def load_and_preprocess_dataset(
    ...
    """Load X-IIoTID arrays and create a reusable global train/test split."""
    ...
    print(
        f"[Data] X-IIoTID loaded: samples={len(y)}, "
